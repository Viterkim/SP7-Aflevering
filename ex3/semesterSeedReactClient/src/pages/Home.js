  ...
  render() {
    return (
      <div>
        ...
        <ul>
          <li>Page for Users (try to login with: username= <b>Peter</b>, password = <b>test</b>)</li>
          <li>Page form Admins (try to login with: username= <b>Anne</b>, password = <b>test</b>)</li>
        </ul>
        <br/>
